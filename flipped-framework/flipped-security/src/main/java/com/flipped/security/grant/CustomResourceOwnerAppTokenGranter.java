...
/**
 * @author chiwenda
 * @date 2022/2/8 下午8:19
 */
public class CustomResourceOwnerAppTokenGranter extends AbstractTokenGranter {
    private static final String GRANT_TYPE = "app";

    private final AuthenticationManager authenticationManager;

    public CustomResourceOwnerAppTokenGranter(AuthenticationManager authenticationManager,
                                              AuthorizationServerTokenServices tokenServices, ClientDetailsService clientDetailsService,
                                              OAuth2RequestFactory requestFactory) {
        this(authenticationManager, tokenServices, clientDetailsService, requestFactory, GRANT_TYPE);
    }

    protected CustomResourceOwnerAppTokenGranter(AuthenticationManager authenticationManager,
                                                 AuthorizationServerTokenServices tokenServices, ClientDetailsService clientDetailsService,
